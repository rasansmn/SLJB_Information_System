<%@ Page Title="Add Vacancy | Sri Lanka Job Bank" Language="VB" MasterPageFile="~/MasterMain.master" AutoEventWireup="false" CodeFile="AddVacancy.aspx.vb" Inherits="Vacancy_AddVacancy" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="cphPerm2" Runat="Server">
    <h2><img alt="" src="../Images/icon6.png" height="25" /> Create a new Vacancy</h2>
<p>Use the form below to add a new Vacancy.</p>

<asp:ValidationSummary ID="AddVacancyValidationSummary" runat="server" CssClass="failureNotification" 
                         ValidationGroup="AddVacancyValidationGroup"/>
...
<p>
    ...
    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
        ...
        ValidationGroup="AddVacancyValidationGroup" CssClass="failureNotification">*</asp:RequiredFieldValidator>
</p>
   <p>
...
<p class="submitButton">
    <asp:Button ID="btnCreateVacancy" runat="server" 
        ValidationGroup="AddVacancyValidationGroup" Text="Create Vacancy" />
</p>
</div> 
</asp:Content>
