<%@ Page Title="Edit Job Campaign | Sri Lanka Job Bank" Language="VB" MasterPageFile="~/MasterMain.master" AutoEventWireup="false" CodeFile="EditCampaign.aspx.vb" Inherits="Campaign_EditCampaign" %>
...
<h2><img alt="" src="../Images/icon9.gif" height="25" /> Edit Job Campaign</h2>
<p>Use the form below to update job campaign.</p>
<span class="failureNotification">
<asp:Literal ID="ErrorMessage" runat="server"></asp:Literal>
</span>
<asp:ValidationSummary ID="AddDisctrictValidationSummary" runat="server" CssClass="failureNotification" 
                         ValidationGroup="EditCampaignValidationGroup"/>
                        ...
                        <fieldset class="register">
                            ...
                            <p>
                                ...
                                <asp:RequiredFieldValidator ID="DisctrictNameRequired" runat="server" ControlToValidate="txtLocation" 
                                     ...
                                     ValidationGroup="EditCampaignValidationGroup">*</asp:RequiredFieldValidator>
                            </p>
   ...
   <p>
       ...
       <asp:DropDownList ID="ddlDivision" runat="server" CssClass="general">
                        ...
                        <p class="submitButton">
                            <asp:Button ID="UpdateCampaignButton" runat="server" CommandName="MoveNext" Text="Update Campaign" 
                                 ValidationGroup="EditCampaignValidationGroup" />
                        </p>
                    </div>
</asp:Content>
