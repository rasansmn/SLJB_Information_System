<%@ Page Title="Edit Job Seeker | Sri Lanka Job Bank" Language="VB" MasterPageFile="~/MasterMain.master" AutoEventWireup="false" CodeFile="EditJobSeeker.aspx.vb" Inherits="Job_Seeker_EditJobSeeker" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="cphPerm1" Runat="Server">
    <h2><img alt="" src="../Images/icon1.jpg" height="25" /> Edit Job Seeker</h2>
<p>Use the form below to edit job seeker.</p>
...
<p class="submitButton">
    <asp:Button ID="btnUpdate" runat="server" Text="Update Job Seeker" 
        ValidationGroup="AddJobSeekerValidationGroup"/>
</p>
</div>
</asp:Content>
