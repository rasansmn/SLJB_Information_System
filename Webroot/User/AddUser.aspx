<%@ Page Title="Add User Account | Sri Lanka Job Bank" Language="VB" MasterPageFile="~/MasterMain.master" AutoEventWireup="false" CodeFile="AddUser.aspx.vb" Inherits="User_AddUser" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphCommon" Runat="Server">
    <h2><img alt="" src="../Images/icon4.jpg" height="25" /> Create a New Account</h2>
...
<div class="accountInfo">
                        <fieldset class="register">
                            ...
                            <p>
                                ...
                                <asp:CustomValidator ID="valUsername" CssClass="failureNotification" ControlToValidate="txtUsername" runat="server" ErrorMessage="Invalid username" ValidationGroup="RegisterUserValidationGroup" ToolTip="User Name is required.">*</asp:CustomValidator>
                            </p>
                            <p>
                            ...
                            <p>
                                ...
                                <asp:RequiredFieldValidator ID="PasswordRequired" runat="server" ControlToValidate="txtPassword" 
                                     ...
                                     ValidationGroup="RegisterUserValidationGroup">*</asp:RequiredFieldValidator>
                                <asp:CustomValidator ID="valPassword" ControlToValidate="txtPassword" CssClass="failureNotification" ToolTip="Invalid password" runat="server" ValidationGroup="RegisterUserValidationGroup" ErrorMessage="Invalid password">*</asp:CustomValidator>
                            </p>
                            <p>
                            ...
                            <p>
                                ...
                                <asp:DropDownList ID="ddlPermission" runat="server" CssClass="general">
